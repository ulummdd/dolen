<?php
  ...
  $show = mysqli_query($connect, "SELECT * FROM pesan ORDER BY id_pesan DESC");
  ...
  <body>
    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fa-solid fa-envelope mr-3"></i>Pesan</h3><hr>
            <table class="table table-striped table-bordered">
              <thead>
                <tr>
                  ...
                  <th scope="col" style="text-align:right;">No. Telepon</th>
              ...
              <?php
                ...
                while($data = mysqli_fetch_array($show)){
                  $pesan = truncate($data['pesan'], 25);
                  echo "<tr>";
                  echo "<th>".$no++."</th>";
                  echo "<td>".$data['pengirim']."</td>";
                  echo "<td>".$data['email']."</td>";
                  echo "<td style='text-align:right;'>+62".$data['no_telp']."</td>";
                  echo "<td>".$pesan."</td>";
                  echo "<td>
                        <center>
                          <a href='detail-pesan.php?id=$data[id_pesan]'><i class='fa-solid fa-eye p-2 text-white rounded' data-toggle='tooltip' title='Detail' style='background-color:#279FA7;'></i></a>
                          <a href='hapus-pesan.php?id=$data[id_pesan]'><i class='fa-solid fa-trash bg-danger p-2 text-white rounded' data-toggle='tooltip' title='Hapus'></i>
                        </center>
                        </td>";
                  echo "</tr>";
            }
