<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $result = mysqli_query($connect, "UPDATE informasi SET judul_informasi='$judul_informasi', isi_informasi='$isi_informasi' WHERE id_informasi='$_GET[id]'");
    if($result){
...
<html lang="en">
  <head>
    ...
    <title>Edit Informasi - Admin Dolen</title>
  </head>
  <body>
    ...
    <div class="row no-gutters">
        ...
        <form action="" method="post" autocomplete="off">
          ...
          ?>
            <h3><i class="fa-solid fa-info-circle mr-3"></i>Edit "<?php echo $data['judul_informasi']; ?>"</h3><hr>
            <div class="mb-3">
              <label for="judul_informasi" class="form-label">Judul informasi</label>
              <input type="text" name="judul_informasi" class="form-control" id="exampleFormControlInput1" value="<?php echo $data['judul_informasi']; ?>">
            </div>
            <div class="mb-3">
              <label for="isi_informasi" class="form-label">Isi Informasi</label>
              <textarea class="form-control" name="isi_informasi" id="isi_informasi" rows="3"><?php echo $data['isi_informasi']; ?></textarea>
            </div>
          <?php
            echo "<input type='submit' name='submit' class='btn btn-primary mb-3' value='Edit informasi'>";
            }
          ?>
        </form>
        </div>
